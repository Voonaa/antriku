            ...
            <>
                ...
                <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center font-sans selection:bg-accent selection:text-white">
                    <div className="text-center px-8 max-w-xl">
                        ...
                        <button
                            onClick={enableAudio}
                            className="bg-accent hover:bg-orange-600 text-white font-black text-2xl md:text-3xl py-8 px-12 rounded-[2rem] shadow-2xl transition-all duration-300 transform hover:scale-105 active:scale-95 flex items-center justify-center gap-5 mx-auto"
                        >
