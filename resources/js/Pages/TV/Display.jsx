    ...
    if (!isAudioEnabled) {
        return (
            <>
                ...
                <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center font-sans selection:bg-primary selection:text-white">
                    <div className="text-center px-8 max-w-xl">
                        ...
                        <button
                            onClick={enableAudio}
                            className="bg-primary hover:bg-teal-600 text-white font-black text-2xl md:text-3xl py-8 px-12 rounded-[2rem] shadow-2xl transition-all duration-300 transform hover:scale-105 active:scale-95 flex items-center justify-center gap-5 mx-auto border border-teal-500"
                        >
        ...
        <>
            ...
            <div className="h-screen bg-black flex overflow-hidden font-sans">
                ...
                <div className="w-[60%] bg-slate-950 flex flex-col p-6">
                    <div className="w-full flex-grow rounded-[2.5rem] overflow-hidden bg-slate-900 border border-slate-800 shadow-2xl relative">
                        {extractYoutubeId(tenant.youtube_url) ? (
                            <iframe
                                src={`https://www.youtube.com/embed/${extractYoutubeId(tenant.youtube_url)}?autoplay=1&mute=1&loop=1&playlist=${extractYoutubeId(tenant.youtube_url)}&controls=0&showinfo=0&rel=0&modestbranding=1`}
                            ...
                            <div className="flex flex-col items-center justify-center w-full h-full">
                                ...
                                <p className="text-slate-500 text-3xl font-black uppercase tracking-widest">Video Promosi</p>
                                <p className="text-slate-600 mt-2 font-medium">Pasang URL YouTube di Dashboard Admin</p>
                            </div>
                        )}
                    </div>
                </div>
                ...
                <div className="w-[40%] bg-primary flex flex-col p-10 border-l border-white/10 shadow-[-20px_0_40px_rgba(0,0,0,0.5)] z-10 relative">
                    ...
                    <div className="flex-grow flex flex-col justify-center items-center text-center relative z-10 -mt-10">
                        ...
                        <div className={`transition-all duration-300 transform ${isBlinking ? 'scale-110' : 'scale-100'}`}>
                            <span className="text-[12rem] font-black text-white drop-shadow-2xl leading-none block my-6">
